...
const s = {
  ...
  input: { flex: 1, background: "none", border: "none", outline: "none", fontSize: 14.5, fontFamily: "inherit", color: "#333" },
  ...
  modelBtn: { background: "#f3f0eb", border: "1px solid #ddd", borderRadius: 20, padding: "4px 11px", fontSize: 13, color: "#555", cursor: "pointer", display: "flex", alignItems: "center", gap: 4, fontFamily: "inherit" },
  spacer: { flex: 1 },
};