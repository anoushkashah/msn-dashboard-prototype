...
export default function GlobalMap() {
  ...
  return (
    <div style={s.card}>
      ...
      <div style={s.mapWrap}>
        <div style={s.mapDesc}>Explore articles across regions</div>
...
const s = {
  ...
  mapWrap: { flex: 1, minHeight: 200, display: "flex", flexDirection: "column", gap: 8 },
  mapDesc: { fontSize: 12, color: "#aaa" },
  mapInner: { flex: 1, borderRadius: 10, overflow: "hidden", position: "relative" },
