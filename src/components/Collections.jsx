...
const s = {
  ...
  statLabel: { fontSize: 11.5, color: "#999" },
  statVal: { fontSize: 19, fontWeight: 600, color: "#1a1a1a", letterSpacing: "-0.4px" },
  chartLabel: { fontSize: 12, color: "#aaa", marginTop: 4 },
  ...
  barVal: { fontSize: 11, color: "#555", fontWeight: 500 },
  barWeek: { fontSize: 10, color: "#bbb", textAlign: "center" },
};