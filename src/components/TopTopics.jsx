...
const s = {
  label: { fontSize: 12, color: "#999", textTransform: "uppercase", letterSpacing: ".06em", marginBottom: 8 },
  ...
  topicLabel: { fontSize: 14, fontWeight: 600, color: "#1a1a1a" },
  icon: { width: 34, height: 34, borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 17, flexShrink: 0 },
  ...
  articleTitle: { fontSize: 12.5, color: "#333", lineHeight: 1.4, marginBottom: 4 },
  articleLink: { fontSize: 11, color: "#0067b8", display: "flex", alignItems: "center", gap: 3 },
};